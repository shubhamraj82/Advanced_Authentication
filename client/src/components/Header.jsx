...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to your developer dashboard</h2>
        <p className='mb-8 max-w-md'>Here you can manage your projects, view analytics, and customize your settings.</p>
